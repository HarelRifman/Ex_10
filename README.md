...
4. Add pull-to-refresh functionality to the news feed (use RefreshControl on FlatList)
5. Dismiss keyboard when tapping outside text inputs (use Keyboard.dismiss() with TouchableWithoutFeedback)